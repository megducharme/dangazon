...
urlpatterns = [
    ...
    url(r'^userProfile/', customer_view.CustomerProfile.as_view(), name='user_profile'),
    url(r'^orderHistory/', order_history_view.get_customer_orders, name='order_history'),
    url(r'^(?P<order_id>[0-9]+)/order/$', order_detail_view.get_order_details, name='order_detail'),
]
